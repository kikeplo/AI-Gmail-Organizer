"""Smart local/cloud AI routing with quota cooldowns, provider failover, and metrics."""
...
class SmartAIRouter:
    ...
    def _put_on_cooldown(self, key: str, error: str) -> None:
        ...
        state.last_error = error; state.last_status = "quota"; state.failures += 1
    ...
    def _success(self, key: str) -> None:
        state = self.states[key]
        state.successes += 1; state.failures = 0; state.cooldown_until = 0; state.last_error = ""; state.last_status = "available"
