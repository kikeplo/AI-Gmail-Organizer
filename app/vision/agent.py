"""Vision-guided desktop agent for AI Gmail Organizer."""
...
class VisionAgent:
    """Observe the Windows screen, choose one safe UI action, execute it, and verify."""
    ...
    def run(self, goal: str, progress=None) -> str:
        ...
        for step in range(1, self.max_steps + 1):
            ...
            if action == "wait":
                ...
                continue
            if action in {"delete", "send", "submit", "purchase"}:
                return "I stopped before a potentially consequential action. Please perform that final action manually."
    ...
    def _decide(self, goal: str, image) -> dict:
        ...
        prompt = (
            ...
            "Never choose send, submit, delete, purchase, or other irreversible final actions. "
